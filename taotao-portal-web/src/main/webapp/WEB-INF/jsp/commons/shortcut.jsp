...
<div id="shortcut-2013">
	<div class="w">
		...
		<ul class="fr lh">
			<li class="fore1" id="loginbar" clstag="homepage|keycount|home2013|01b">您好！欢迎来到淘淘！<a href="http://localhost:8088/page/login">[登录]</a>&nbsp;<a href="http://localhost:8088/page/register">[免费注册]</a></li>
